...
function _M.run()
 -- cookie=ngx.req.get_header("Cookie")
  ...
  local path_pattern="/api/v1/data/(oauth|talent)/(34fa6f5dcaec9149a513c0193002e77d|e6c2550b9b069be64a79d8a40bf94bed)\\?code=[0-9a-zA-Z]{1,10}&client_id=(kexie|talent)"
